...
input_path_sanitize_automation = input_common_dir + 'Assessment\\sanitizeautomation.xls'
...
output_path_sanitize_automation = output_common_dir + 'Assessment\\reinitiate\\API_sanitize - '
